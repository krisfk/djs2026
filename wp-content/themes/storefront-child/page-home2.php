...
<!-- Make banners full width by placing slider OUTSIDE #primary and using fluid CSS -->
<style>
    .home-banner-slider-fullwidth {
        width: 100vw;
        max-width: 100vw;
        ...
        margin-right: -50vw;
        background: #fff;
        /* optional: keeps white bg if content is narrower */
        padding-top: 12px;
        padding-bottom: 12px;
    }
    .banner-list {
...
<div class="home-banner-slider-fullwidth">
